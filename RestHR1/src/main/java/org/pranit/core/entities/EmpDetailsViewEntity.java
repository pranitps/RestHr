...
@NamedQuery(name="EmpDetailsViewEntity.findAll", query="SELECT e FROM EmpDetailsViewEntity e")
public class EmpDetailsViewEntity implements Serializable {
